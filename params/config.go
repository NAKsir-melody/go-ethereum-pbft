...
var (
	...
	AllPbftProtocolChanges = &ChainConfig{big.NewInt(1338), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, &PbftConfig{Period: 15, Epoch: 30000}}
...
type ChainConfig struct {
	...
	Pbft   *PbftConfig   `json:"clique,omitempty"`
}
